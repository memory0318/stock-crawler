...
@Entity
@Table(
		name = StockMonthlyTradingEntity.TABLE_NAME,
		schema = Constants.SCHEMA_PUBLIC
)
public class StockMonthlyTradingEntity {

	// ----- ----- Public constants
	// Table name
	public static final String TABLE_NAME = "stk_month_trading";
	// Column name
	...
	public StockMonthlyTradingEntity() { }

	private StockMonthlyTradingEntity(Builder builder) {
		sn = builder.sn;
	...
	public static final class Builder {
		...
		public Builder(StockMonthlyTradingEntity copy) {
			this.sn = copy.getSn();
			this.securityCode = copy.getSecurityCode();
			this.date = copy.getDate();
			this.tradeVolume = copy.getTradeVolume();
			this.tradeValue = copy.getTradeValue();
			this.openingPrice = copy.getOpeningPrice();
			this.highestPrice = copy.getHighestPrice();
			this.lowestPrice = copy.getLowestPrice();
			this.closingPrice = copy.getClosingPrice();
			this.change = copy.getChange();
			this.transaction = copy.getTransaction();
		}
		...
		public StockMonthlyTradingEntity build() {
			return new StockMonthlyTradingEntity(this);
		}
	}
}
