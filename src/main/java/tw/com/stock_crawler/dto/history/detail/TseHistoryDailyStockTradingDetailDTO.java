...
public class TseHistoryDailyStockTradingDetailDTO {

	@JsonProperty
	@JsonDeserialize(using = MinguoDateTimeDeserializer.class)
	...
	public TseHistoryDailyStockTradingDetailDTO() { }

	private TseHistoryDailyStockTradingDetailDTO(Builder builder) {
	...
	public static final class Builder {
		...
		@Nonnull
		public TseHistoryDailyStockTradingDetailDTO build() {
			return new TseHistoryDailyStockTradingDetailDTO(this);
		}
	}
}
